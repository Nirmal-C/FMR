            ...
            function refreshComplaintView() {
                ...
                fetch('showComplaintDatainModel', {
                    ...
                    if (res != null) {
                        ...
                        $('#customer_other_preview').text(customerBranch);
                        ...
                        $('#officer_mobile_preview').text(mobile);
                        $('#officer_email_preview').text(email);
...
// Remove existing buttons in the "buttonGroupforComplaint" class
    ...
    function hadleButtonInAction(actionTaken, pending_complition) {
        ...
        if (actionTaken === 'Rejected' && pending_complition === 'false') {
            ...
            var completedButton = $('<a href="javascript:void(0)" class="addComment" data-toggle="tooltip" data-placement="top" title="Add Complaintnnn"><i class="bi bi-chat-left-text" style="font-size:40px; margin-left:10px; color:black"></i></a>');
            $('.buttonGroupforComplaint').append(completedButton);
        ...
        $(row).on('click', function () {
            ...
            fetch('showComplaintDatainModel', {
                ...
                if (res != null) {
                    ...
                    $('#customer_other_previewOfficer').text(customerBranch);
                    ...
                    $('#officer_mobile_previewOfficer').text(mobile);
                    $('#officer_email_previewOfficer').text(email);
...
// Remove existing buttons in the "buttonGroupforComplaint" class
    ...
    function hadleButtonInAction(actionTaken) {
        ...
        if (actionTaken === 'Rejected' && pending_complition === 'false') {
            ...
            var completedButton = $('<a href="javascript:void(0)" class="addComment" data-toggle="tooltip" data-placement="top" title="Add Complaintc"><i class="bi bi-chat-left-text" style="font-size:40px; margin-left:10px; color:black"></i></a><a href="javascript:void(0)" class="reOpenComplaint" data-toggle="tooltip" data-placement="top" title="Reopen Complaint"><i class="bi bi-arrow-repeat" style="font-size:40px; color:orange;"></i></a>');
...
// Get the value of the textarea
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return fetch('admin/assign-new-officerForPendingComplition', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                ...
                if (result.isConfirmed) {
                    ...
                    const modalAssign = new bootstrap.Modal(document.getElementById('ExtralargeModalViewComplaintOfficer'));
                    modalAssign.show();
                }
            });
        });
...
//    dtable12345.ajax.reload();

//this code is to show officer own complaints

    $.fn.dataTable.ext.errMode = 'none';
    var dtable12345 = $('#viewOfficerComplaintasTableNewAdminDashboardMy').DataTable({
...
//                                    '<div class="tl-date text-muted mt-1">Age - ' + item.age + '</div>' +
    ...
    dtable12345.catch((error) => console.error(error));
